...
double KinemaKstar::p2E(double p,double m)
{
  return sqrt(p*p + m*m);
}
...
double KinemaKstar::deg2rad(double theta) {
  return 3.141592654*theta/180.0;
}

double KinemaKstar::rag2deg(double rag)
{
...
double KinemaKstar::GetEnergy(int i)
{
  switch (i) {
  case 1:
    return kin3.E_1_lab;
  ...
  case 4:
    ...
    break;
  default:
    fprintf(stderr, "KinemaKstar::GetEnergy No such particle %d\n", i);
    exit(1);
  }
}

double KinemaKstar::GetMomentum(int i)
{
  switch (i) {
  case 1:
    return kin3.p_1_lab;
  ...
  case 4:
    ...
    break;
  default:
    fprintf(stderr, "KinemaKstar::GetMomentum No such particle %d\n", i);
    exit(1);
  }
}

void KinemaKstar::GetMomentum(int i, double *mom)
{
  switch (i) {
  case 1:
    mom[0] = 0.0;
...
double KinemaKstar::GetTheta(int i)
{
  switch (i) {
  case 1:
    return 0.0;
  ...
  case 4:
    ...
    break;
  default:
    fprintf(stderr, "KinemaKstar::GetTheta No such particle %d\n", i);
    exit(1);
  }
}

double KinemaKstar::GetPhi(int i)
{
  switch (i) {
  case 1:
    return 0.0;
  ...
  case 4:
    ...
    break;
  default:
    fprintf(stderr, "KinemaKstar::GetPhi No such particle %d\n", i);
    exit(1);
  }
}

double KinemaKstar::GetThetaCM(int i)
{
  switch (i) {
  case 1:
    ...
    break;
  default:
    fprintf(stderr, "KinemaKstar::GetThetaCM index should be 1 or 2 ->%d\n", i);
    exit(1);
  }
}

double KinemaKstar::GetPhiCM(int i)
{
  switch (i) {
  case 1:
    return kin3.Phi1;
    break;
  default:
    fprintf(stderr, "KinemaKstar::GetPhiCM index should be 1 or 2 ->%d\n", i);
    exit(1);
  }
}


void KinemaKstar::RotateMom(int i, double deg, double *mom)
{
  double Sin,Cos;
  ...
  case 4:
    ...
    break;
  default:
    fprintf(stderr, "KinemaKstar::RotateMom should be 3,4->%d\n",i);
    exit(1);
  }
}
