  ...
  *theta = rag2deg(acos(unitx));
  ...
  if (unity>=0.0 && unitz>0.0) 
    ...
    *phi = 360.0-rag2deg(acos(unity/sin(deg2rad(*theta))));
    ...
    fprintf(stderr,
	  "KinemaHWeakNonReso::CalcDistribution No such reagion unity=%f, unitz=%f\n",
	    unity, unitz);
    Dump();
    exit(1);
  }
...
double KinemaHWeakNonReso::GetEnergy(int i)
{
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaHWeakNonReso::GetEnergy No such particle %d\n", i);
    exit(1);
  }
}
...
double KinemaHWeakNonReso::GetMomentum(int i)
{
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaHWeakNonReso::GetMomentum No such particle %d\n", i);
    exit(1);
  }
}
...
double KinemaHWeakNonReso::GetTheta(int i)
{
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaHWeakNonReso::GetTheta No such particle %d\n", i);
    exit(1);
  }
}
...
double KinemaHWeakNonReso::GetPhi(int i)
{
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaHWeakNonReso::GetPhi No such particle %d\n", i);
    exit(1);
  }
}
...
double KinemaHWeakNonReso::GetThetaCM(int i)
{
  ...
  case 2:
    ...
    break;
  default:
    fprintf(stderr, "KinemaHWeakNonReso::GetThetaCM index should be 1 or 2 ->%d\n", i);
    exit(1);
  }
}
...
double KinemaHWeakNonReso::GetPhiCM(int i)
{
  ...
  case 2:
    ...
    break;
  default:
    fprintf(stderr, "KinemaHWeakNonReso::GetPhiCM index should be 1 or 2 ->%d\n", i);
    exit(1);
  }
}
...
void KinemaHWeakNonReso::RotateMom(int i, double deg, double *mom)
{
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaHWeakNonReso::RotateMom should be 3,4,5 ->%d\n",i);
    exit(1);
  }
}
