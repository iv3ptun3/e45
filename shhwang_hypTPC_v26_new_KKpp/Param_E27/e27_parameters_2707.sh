...
#export Generator=2703 #### K-pp -> Lp  gun
#export Generator=2704 #### K-pp -> Szp gun
#export Generator=2705 #### K-pp -> LPizp gun
#export Generator=2706 #### K-pp -> SzPizp gun
export Generator=2707 #### K-pp -> SpPimp gun


export Experiment_NUM=27 ####dedx test
...
export AC_Skim=1. ##"1" is on. "0" is off
...
#export Beam_mom=1.8 #
export Beam_mom=1.69 #
#export Beam_mom=0.8 #test K+ beam
export Beam_width=0.0115 # E27 condition
export Beam_x0=-0.414 # E27 condition
export Beam_y0=0.0489 # E27 conditio
export Beam_dx=7.62 # E27 condition
export Beam_dy=4.2 # E27 condition
export Beam_u0=0.00201 # E27 condition
export Beam_v0=-0.00141 # E27 conditio
export Beam_du=0.012 # E27 condition
export Beam_dv=0.00311 # E27 condition


#### Spectrometer angle //plus left , minus right
export Spectrometer_ang=6.5
