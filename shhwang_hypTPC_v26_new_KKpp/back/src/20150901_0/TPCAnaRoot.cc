...
void TPCAnaRoot::BeginOfRunAction(int runnum)
{
  ...
  //Num Of Hit for K+
  tree->Branch("HitNum_K",&tree1ev.HitNum_K,"HitNum_K/I");
  tree->Branch("HitNumAC_K",&tree1ev.HitNumAC_K,"HitNumAC_K/I");
  tree->Branch("HitNumNBAR_K",&tree1ev.HitNumNBAR_K,"HitNumNBAR_K/I");
  tree->Branch("HitNumDC_K",&tree1ev.HitNumDC_K,"HitNumDC_K/I");
  tree->Branch("HitNumFTOF_K",&tree1ev.HitNumFTOF_K,"HitNumFTOF_K/I");
  tree->Branch("HitNumCH_K",&tree1ev.HitNumCH_K,"HitNumCH_K/I");
  tree->Branch("HitNumScint_K",&tree1ev.HitNumScint_K,"HitNumScint_K/I");
  tree->Branch("HitNumTarget_K",&tree1ev.HitNumTarget_K,"HitNumTarget_K/I");


  //Num Of Hit for proton for K- C -> p + X experiment
  tree->Branch("HitNum_p",&tree1ev.HitNum_p,"HitNum_p/I");
  tree->Branch("HitNumAC_p",&tree1ev.HitNumAC_p,"HitNumAC_p/I");
  tree->Branch("HitNumNBAR_p",&tree1ev.HitNumNBAR_p,"HitNumNBAR_p/I");
  tree->Branch("HitNumDC_p",&tree1ev.HitNumDC_p,"HitNumDC_p/I");
  tree->Branch("HitNumFTOF_p",&tree1ev.HitNumFTOF_p,"HitNumFTOF_p/I");
  tree->Branch("HitNumCH_p",&tree1ev.HitNumCH_p,"HitNumCH_p/I");
  tree->Branch("HitNumScint_p",&tree1ev.HitNumScint_p,"HitNumScint_p/I");
  tree->Branch("HitNumTarget_p",&tree1ev.HitNumTarget_p,"HitNumTarget_p/I");
  ...
  //  tree->Branch("laypad",tree1ev.laypad,"laytpadpc[nttpc][nthlay[nttpc]][nthpad[nttpc]]/I");
  //  tree->Branch("laypad",tree1ev.laypad,"laytpadpc[nttpc][nthlay][nthpad]/I");
  ...
  ////ac
  tree->Branch("ntac",&tree1ev.ntac,"ntac/I");
  tree->Branch("tidac",tree1ev.tidac,"tidac[ntac]/I");
  tree->Branch("pidac",tree1ev.pidac,"pidac[ntac]/I");
  tree->Branch("didac",tree1ev.didac,"didac[ntac]/I");
  tree->Branch("massac",tree1ev.massac,"massac[ntac]/D");
  tree->Branch("qqac",tree1ev.qqac,"qqac[ntac]/I");
  tree->Branch("xac",tree1ev.xac,"xac[ntac]/D");
  tree->Branch("yac",tree1ev.yac,"yac[ntac]/D");
  tree->Branch("zac",tree1ev.zac,"zac[ntac]/D");
  tree->Branch("pxac",tree1ev.pxac,"pxac[ntac]/D");
  tree->Branch("pyac",tree1ev.pyac,"pyac[ntac]/D");
  tree->Branch("pzac",tree1ev.pzac,"pzac[ntac]/D");
  tree->Branch("ppac",tree1ev.ppac,"ppac[ntac]/D");
  tree->Branch("tofac",tree1ev.tofac,"tofac[ntac]/D");
  tree->Branch("acpID",tree1ev.acpID,"acpID[ntac]/I");

  tree->Branch("trvtxpxac",tree1ev.trvtxpxac,"trvtxpxac[ntac]/D");
  tree->Branch("trvtxpyac",tree1ev.trvtxpyac,"trvtxpyac[ntac]/D");
  tree->Branch("trvtxpzac",tree1ev.trvtxpzac,"trvtxpzac[ntac]/D");
  tree->Branch("trvtxppac",tree1ev.trvtxppac,"trvtxppac[ntac]/D");

  tree->Branch("trvtxxac",tree1ev.trvtxxac,"trvtxxac[ntac]/D");
  tree->Branch("trvtxyac",tree1ev.trvtxyac,"trvtxyac[ntac]/D");
  tree->Branch("trvtxzac",tree1ev.trvtxzac,"trvtxzac[ntac]/D");
  tree->Branch("lengthac",tree1ev.lengthac,"lengthac[ntac]/D");


  ////nbar
  tree->Branch("ntnbar",&tree1ev.ntnbar,"ntnbar/I");
  tree->Branch("tidnbar",tree1ev.tidnbar,"tidnbar[ntnbar]/I");
  tree->Branch("pidnbar",tree1ev.pidnbar,"pidnbar[ntnbar]/I");
  tree->Branch("didnbar",tree1ev.didnbar,"didnbar[ntnbar]/I");
  tree->Branch("massnbar",tree1ev.massnbar,"massnbar[ntnbar]/D");
  tree->Branch("qqnbar",tree1ev.qqnbar,"qqnbar[ntnbar]/I");
  tree->Branch("xnbar",tree1ev.xnbar,"xnbar[ntnbar]/D");
  tree->Branch("ynbar",tree1ev.ynbar,"ynbar[ntnbar]/D");
  tree->Branch("znbar",tree1ev.znbar,"znbar[ntnbar]/D");
  tree->Branch("pxnbar",tree1ev.pxnbar,"pxnbar[ntnbar]/D");
  tree->Branch("pynbar",tree1ev.pynbar,"pynbar[ntnbar]/D");
  tree->Branch("pznbar",tree1ev.pznbar,"pznbar[ntnbar]/D");
  tree->Branch("ppnbar",tree1ev.ppnbar,"ppnbar[ntnbar]/D");
  tree->Branch("tofnbar",tree1ev.tofnbar,"tofnbar[ntnbar]/D");
  tree->Branch("nbarpID",tree1ev.nbarpID,"nbarpID[ntnbar]/I");

  tree->Branch("trvtxpxnbar",tree1ev.trvtxpxnbar,"trvtxpxnbar[ntnbar]/D");
  tree->Branch("trvtxpynbar",tree1ev.trvtxpynbar,"trvtxpynbar[ntnbar]/D");
  tree->Branch("trvtxpznbar",tree1ev.trvtxpznbar,"trvtxpznbar[ntnbar]/D");
  tree->Branch("trvtxppnbar",tree1ev.trvtxppnbar,"trvtxppnbar[ntnbar]/D");

  tree->Branch("trvtxxnbar",tree1ev.trvtxxnbar,"trvtxxnbar[ntnbar]/D");
  tree->Branch("trvtxynbar",tree1ev.trvtxynbar,"trvtxynbar[ntnbar]/D");
  tree->Branch("trvtxznbar",tree1ev.trvtxznbar,"trvtxznbar[ntnbar]/D");
  tree->Branch("lengthnbar",tree1ev.lengthnbar,"lengthnbar[ntnbar]/D");



  ///CH
  tree->Branch("ntch",&tree1ev.ntch,"ntch/I");
  tree->Branch("tidch",tree1ev.tidch,"tidch[ntch]/I");
  tree->Branch("pidch",tree1ev.pidch,"pidch[ntch]/I");
  tree->Branch("didch",tree1ev.didch,"didch[ntch]/I");
  tree->Branch("massch",tree1ev.massch,"massch[ntch]/D");
  tree->Branch("qqch",tree1ev.qqch,"qqch[ntch]/I");
  tree->Branch("xch",tree1ev.xch,"xch[ntch]/D");
  tree->Branch("ych",tree1ev.ych,"ych[ntch]/D");
  tree->Branch("zch",tree1ev.zch,"zch[ntch]/D");
  tree->Branch("pxch",tree1ev.pxch,"pxch[ntch]/D");
  tree->Branch("pych",tree1ev.pych,"pych[ntch]/D");
  tree->Branch("pzch",tree1ev.pzch,"pzch[ntch]/D");
  tree->Branch("ppch",tree1ev.ppch,"ppch[ntch]/D");
  tree->Branch("tofch",tree1ev.tofch,"tofch[ntch]/D");
  tree->Branch("chpID",tree1ev.chpID,"chpID[ntch]/I");

  tree->Branch("trvtxpxch",tree1ev.trvtxpxch,"trvtxpxch[ntch]/D");
  tree->Branch("trvtxpych",tree1ev.trvtxpych,"trvtxpych[ntch]/D");
  tree->Branch("trvtxpzch",tree1ev.trvtxpzch,"trvtxpzch[ntch]/D");
  tree->Branch("trvtxppch",tree1ev.trvtxppch,"trvtxppch[ntch]/D");

  tree->Branch("trvtxxch",tree1ev.trvtxxch,"trvtxxch[ntch]/D");
  tree->Branch("trvtxych",tree1ev.trvtxych,"trvtxych[ntch]/D");
  tree->Branch("trvtxzch",tree1ev.trvtxzch,"trvtxzch[ntch]/D");
  tree->Branch("lengthch",tree1ev.lengthch,"lengthch[ntch]/D");


  ///FTOF
  tree->Branch("ntftof",&tree1ev.ntftof,"ntftof/I");
  tree->Branch("tidftof",tree1ev.tidftof,"tidftof[ntftof]/I");
  tree->Branch("pidftof",tree1ev.pidftof,"pidftof[ntftof]/I");
  tree->Branch("didftof",tree1ev.didftof,"didftof[ntftof]/I");
  tree->Branch("massftof",tree1ev.massftof,"massftof[ntftof]/D");
  tree->Branch("qqftof",tree1ev.qqftof,"qqftof[ntftof]/I");
  tree->Branch("xftof",tree1ev.xftof,"xftof[ntftof]/D");
  tree->Branch("yftof",tree1ev.yftof,"yftof[ntftof]/D");
  tree->Branch("zftof",tree1ev.zftof,"zftof[ntftof]/D");
  tree->Branch("pxftof",tree1ev.pxftof,"pxftof[ntftof]/D");
  tree->Branch("pyftof",tree1ev.pyftof,"pyftof[ntftof]/D");
  tree->Branch("pzftof",tree1ev.pzftof,"pzftof[ntftof]/D");
  tree->Branch("ppftof",tree1ev.ppftof,"ppftof[ntftof]/D");
  tree->Branch("tofftof",tree1ev.tofftof,"tofftof[ntftof]/D");
  tree->Branch("ftofpID",tree1ev.ftofpID,"ftofpID[ntftof]/I");

  tree->Branch("trvtxpxftof",tree1ev.trvtxpxftof,"trvtxpxftof[ntftof]/D");
  tree->Branch("trvtxpyftof",tree1ev.trvtxpyftof,"trvtxpyftof[ntftof]/D");
  tree->Branch("trvtxpzftof",tree1ev.trvtxpzftof,"trvtxpzftof[ntftof]/D");
  tree->Branch("trvtxppftof",tree1ev.trvtxppftof,"trvtxppftof[ntftof]/D");

  tree->Branch("trvtxxftof",tree1ev.trvtxxftof,"trvtxxftof[ntftof]/D");
  tree->Branch("trvtxyftof",tree1ev.trvtxyftof,"trvtxyftof[ntftof]/D");
  tree->Branch("trvtxzftof",tree1ev.trvtxzftof,"trvtxzftof[ntftof]/D");
  tree->Branch("lengthftof",tree1ev.lengthftof,"lengthftof[ntftof]/D");
  ...
  //
  /*
  tree->Branch("ntfdc",&tree1ev.ntfdc,"ntfdc/I");
  tree->Branch("tidfdc",tree1ev.tidfdc,"tidfdc[ntfdc]/I");
  tree->Branch("pidfdc",tree1ev.pidfdc,"pidfdc[ntfdc]/I");
  tree->Branch("didfdc",tree1ev.didfdc,"didfdc[ntfdc]/I");
  tree->Branch("xfdc",tree1ev.xfdc,"xfdc[ntfdc]/D");
  tree->Branch("yfdc",tree1ev.yfdc,"yfdc[ntfdc]/D");
  tree->Branch("zfdc",tree1ev.zfdc,"zfdc[ntfdc]/D");
  tree->Branch("pxfdc",tree1ev.pxfdc,"pxfdc[ntfdc]/D");
  tree->Branch("pyfdc",tree1ev.pyfdc,"pyfdc[ntfdc]/D");
  tree->Branch("pzfdc",tree1ev.pzfdc,"pzfdc[ntfdc]/D");
  tree->Branch("toffdc",tree1ev.toffdc,"toffdc[ntfdc]/D");
  */

  ////DC
  tree->Branch("ntdc",&tree1ev.ntdc,"ntdc/I");
  tree->Branch("tiddc",tree1ev.tiddc,"tiddc[ntdc]/I");
  tree->Branch("piddc",tree1ev.piddc,"piddc[ntdc]/I");
  tree->Branch("diddc",tree1ev.diddc,"diddc[ntdc]/I");
  tree->Branch("massdc",tree1ev.massdc,"massdc[ntdc]/D");
  tree->Branch("qqdc",tree1ev.qqdc,"qqdc[ntdc]/I");
  tree->Branch("xdc",tree1ev.xdc,"xdc[ntdc]/D");
  tree->Branch("ydc",tree1ev.ydc,"ydc[ntdc]/D");
  tree->Branch("zdc",tree1ev.zdc,"zdc[ntdc]/D");
  tree->Branch("pxdc",tree1ev.pxdc,"pxdc[ntdc]/D");
  tree->Branch("pydc",tree1ev.pydc,"pydc[ntdc]/D");
  tree->Branch("pzdc",tree1ev.pzdc,"pzdc[ntdc]/D");
  tree->Branch("ppdc",tree1ev.ppdc,"ppdc[ntdc]/D");
  tree->Branch("tofdc",tree1ev.tofdc,"tofdc[ntdc]/D");
  tree->Branch("dcpID",tree1ev.dcpID,"dcpID[ntdc]/I");

  tree->Branch("trvtxpxdc",tree1ev.trvtxpxdc,"trvtxpxdc[ntdc]/D");
  tree->Branch("trvtxpydc",tree1ev.trvtxpydc,"trvtxpydc[ntdc]/D");
  tree->Branch("trvtxpzdc",tree1ev.trvtxpzdc,"trvtxpzdc[ntdc]/D");
  tree->Branch("trvtxppdc",tree1ev.trvtxppdc,"trvtxppdc[ntdc]/D");

  tree->Branch("trvtxxdc",tree1ev.trvtxxdc,"trvtxxdc[ntdc]/D");
  tree->Branch("trvtxydc",tree1ev.trvtxydc,"trvtxydc[ntdc]/D");
  tree->Branch("trvtxzdc",tree1ev.trvtxzdc,"trvtxzdc[ntdc]/D");
  tree->Branch("lengthdc",tree1ev.lengthdc,"lengthdc[ntdc]/D");
...
void TPCAnaRoot::FillTPCData(G4double tpcpx,G4double tpcpy,
			     ...
			     G4int tpcpid, G4int tpcparentid, 
			     G4int tpcqq, 
...
void TPCAnaRoot::FillPrimaryParticle(int id, double* x0, double* p0)
{
