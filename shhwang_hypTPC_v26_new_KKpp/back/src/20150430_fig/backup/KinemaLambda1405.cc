...
#include "KinemaLambda1405.hh"
#include "Randomize.hh"
#include "G4ios.hh"

#define PI 3.141592654

KinemaLambda1405::KinemaLambda1405(double m1, double m2, double m3, double m4, double m5, double m_res, double width, double p1, double p2)
{
  double ECM;
...
double KinemaLambda1405::p2E(double p,double m)
{
  return sqrt(p*p + m*m);
}

void KinemaLambda1405::CalcDistoribution(double unitx, double unity, double unitz, double *theta, double *phi)
{
  ...
  *phi=rag2deg(atan2(unity,unitx));
  /*  if (unity>=0.0 && unitz>0.0) 
    ...
    *phi = 360.0-rag2deg(acos(unity/sin(deg2rad(*theta))));
    ...
    fprintf(stderr,
	  "KinemaLambda1405::CalcDistribution No such reagion unity=%f, unitz=%f\n",
	    unity, unitz);
...
double KinemaLambda1405::deg2rad(double theta) {
  return 3.141592654*theta/180.0;
}

double KinemaLambda1405::rag2deg(double rag)
{
  return 360.0 * rag/ (2.0 * 3.141592654);
}

    
double KinemaLambda1405::RandSin(void)
{
  int success=0;
  double x,fx;
  do {
...
void KinemaLambda1405::Dump(void)
{
  printf("======KinemaLambda1405 Dump======\n");
  printf("--Particle1--\n");
...
double KinemaLambda1405::GetEnergy(int i)
{
  switch (i) {
  case 1:
    return kin3.E_1_lab;
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaLambda1405::GetEnergy No such particle %d\n", i);
    exit(1);
  }
}

double KinemaLambda1405::GetMomentum(int i)
{
  switch (i) {
  case 1:
    return kin3.p_1_lab;
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaLambda1405::GetMomentum No such particle %d\n", i);
    exit(1);
  }
}

void KinemaLambda1405::GetMomentum(int i, double *mom)
{
  switch (i) {
  case 1:
    mom[0] = kin3.p_1_lab;
...
double KinemaLambda1405::GetTheta(int i)
{
  switch (i) {
  case 1:
    return 0.0;
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaLambda1405::GetTheta No such particle %d\n", i);
    exit(1);
  }
}

double KinemaLambda1405::GetPhi(int i)
{
  switch (i) {
  case 1:
    return 0.0;
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaLambda1405::GetPhi No such particle %d\n", i);
    exit(1);
  }
}

double KinemaLambda1405::GetThetaCM(int i)
{
  switch (i) {
  case 1:
  ...
  case 2:
    ...
    break;
  default:
    fprintf(stderr, "KinemaLambda1405::GetThetaCM index should be 1 or 2 ->%d\n", i);
    exit(1);
  }
}

double KinemaLambda1405::GetPhiCM(int i)
{
  switch (i) {
  case 1:
    return kin3.Phi1;
  ...
  case 2:
    ...
    break;
  default:
    fprintf(stderr, "KinemaLambda1405::GetPhiCM index should be 1 or 2 ->%d\n", i);
    exit(1);
  }
}


void KinemaLambda1405::RotateMom(int i, double deg, double *mom)
{
  double Sin,Cos;
  ...
  case 5:
    ...
    break;
  default:
    fprintf(stderr, "KinemaLambda1405::RotateMom should be 3,4,5 ->%d\n",i);
    exit(1);
  }

}

double KinemaLambda1405::GetResMass(void)
{
  return kin3.M_res;
}
