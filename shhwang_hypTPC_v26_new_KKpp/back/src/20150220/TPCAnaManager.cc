    ...
    */
    ...
    for( G4int i=0; i<tpctrNum; i++){
      ...
      anaRoot.FillTPCData(tpcData[i].tpcpx,
			  ...
			  tpcData[i].tpcpp,tpcData[i].tpcqq,
...
void TPCAnaManager::SetTPCData(G4int tpctr2, G4double tpcpx2, G4double tpcpy2,G4double tpcpz2,G4double tpcpp2,  G4int tpcqq2, G4double tpcpm2, G4double tpcde2, G4double tpclen2, G4int tpclay2, 
