#ifndef __KINEMALAMBDA1405_HH__
#define __KINEMALAMBDA1405_HH__

#include "Kinema2Body.hh"
struct KINEMA_LAMBDA1405{
  double E_1_lab;
  double p_1_lab;
  double M_1;
...
class KinemaLambda1405 {
private:
  Kinema2Body kin1;
  Kinema2Body kin2;
  KINEMA_LAMBDA1405 kin3;

public:
  KinemaLambda1405(double m1, double m2, double m3, double m4, double m5, double m_res, double width, double p1, double p2);
