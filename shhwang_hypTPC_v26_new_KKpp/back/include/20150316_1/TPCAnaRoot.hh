...
const G4int MaxPrimaryParticle = 6;
...
struct Tree1Ev {
  ...
  G4double mm_p;  //missing-mass for proton target kinematics
...
public:
  ...
  void FillPrimaryParticle(int id, double* x0, double* p0);
  ...
  void FillTPCData(G4double tpcpx1,G4double tpcpy1,
		   G4double tpcpz1,G4double tpcpp1, G4int tpcqq1, 
