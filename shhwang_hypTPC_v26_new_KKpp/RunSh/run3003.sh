...
export Generator=3003

#for((i=0; $i<100; i++))
for((i=0; $i<10; i++))
{
    export Out_ROOT_File_Name=./rootfiles/KKpp/KKpp_LSmPip/back/test_woEM_3003_$i.root
    export Out_GEN_File_Name=./rootfiles/KKpp/KKpp_LSmPip/back/test_woEM_3003_gen_$i.root
