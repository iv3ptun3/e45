...
public:
  ...
  G4ThreeVector GetPosition( void ) const { return m_position; }
  G4ThreeVector GetMomentum( void ) const { return m_momentum; }
  ...
  { return m_vertex_kinetic_energy; } // sqrt(p^2+m^2)-m
